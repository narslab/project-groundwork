...
def calculate_additional_cost_from_under_after_lifespan(data):
    ...
    df_analyze_additional.to_csv(r'../../results/outcomes/Analyze result-Additional cost.csv', index = False)
...
def calculate_net_present_value_of_additional_cost(data):
      list1=calculate_net_present_value_under_after_lifespan(data)
      list2=calculate_net_present_value_statusQuo(data)
      difference = []
