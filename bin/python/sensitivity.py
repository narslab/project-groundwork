...
def calculate_cost_npv_S10(data, data_broadband):
    # S10
    ...
    total_cost=S10_df_npv['total_cost_el']+S10_df_npv['total_cost_br']
    return(total_cost)


### run cost sensitivity analysis for a parameter
def run_sensitivity_cost_JAA(parameter1, percentage_change1,
    ...
    if broadband==True:
        ...
        if  parameter2==None:
            ...
            new_result=calculate_cost_npv_S10(new_data1, data)
        else:
            new_data1=network.Electric_model_inputs()
            new_data1.modify_parameter(parameter1, percentage_change1, parameter2)
            original_result=calculate_cost_npv_S10(model_data, data)
...
def calculate_benefit_npv_S10(data, data_broadband):
    # S1
    df_output_S1=Simulate.run_benefit_simulation_S10(data, data_broadband)
...
def run_sensitivity_benefit_SQ(parameter1, percentage_change1,
    ...
    if broadband==True:
        ...
        if  parameter2==None:           
            new_data1=network.Broadband_model_inputs()
            new_data1.modify_parameter(parameter1, percentage_change1)
            original_result=Simulate.run_benefit_simulation_S10_to_s13(data_el, data_br)
            new_result=Simulate.run_benefit_simulation_S10_to_s13(data_el, new_data1)
        else:
            new_data1=network.Broadband_model_inputs()
            new_data1.modify_parameter(parameter1, percentage_change1,parameter2)
            original_result=Simulate.run_benefit_simulation_S10_to_s13(data_el, data_br)
        ...
        if  parameter2==None:
            ...
            new_data1.modify_parameter(parameter1, percentage_change1)
            original_result=Simulate.run_benefit_simulation_S10_to_s13(data_el, data_br)
            new_result=Simulate.run_benefit_simulation_S10_to_s13(new_data1, data_br)
        else:
            new_data1=network.Electric_model_inputs()
            new_data1.modify_parameter(parameter1, percentage_change1, parameter2)
            original_result=Simulate.run_benefit_simulation_S10_to_s13(data_el, data_br)
